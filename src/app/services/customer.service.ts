  ...
  private customers: Customer[] = [
    {
      ...
      status: 'Active', locations: 4, connectors: 18, activeConnections: 214, bandwidthUsed: '980 GB', uptime: '99.98%',
    ...
    },
    {
      ...
      status: 'Active', locations: 6, connectors: 31, activeConnections: 512, bandwidthUsed: '2.1 TB', uptime: '100%',
    ...
    },
    {
      ...
      status: 'Active', locations: 2, connectors: 9, activeConnections: 87, bandwidthUsed: '420 GB', uptime: '99.95%',
    ...
    },
    {
      ...
      status: 'Active', locations: 2, connectors: 8, activeConnections: 94, bandwidthUsed: '310 GB', uptime: '99.80%',
      alertSeverity: 'Warning',
      alerts: [
    ...
    },
    {
      ...
      status: 'Degraded', locations: 3, connectors: 12, activeConnections: 43, bandwidthUsed: '210 GB', uptime: '97.40%',
      alertSeverity: 'Critical',
      alerts: [
    ...
    },
    {
      ...
      status: 'Inactive', locations: 1, connectors: 4, activeConnections: 0, bandwidthUsed: '0 GB', uptime: '—',
      alertSeverity: 'None', alerts: [],
      locationList: [
