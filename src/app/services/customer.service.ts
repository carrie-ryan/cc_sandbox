...
export interface CustomerIdentity {
  id: string;
  name: string;
  type: 'user' | 'device' | 'gateway' | 'clientless' | 'sdk';
  location?: string;
  device?: string;
  ...
  private customers: Customer[] = [
    {
      ...
      connectorList: [
        { id: 'Chicago-GW-01', name: 'cad-gateway', type: 'gateway', location: 'Chicago HQ', connectors: 2, usageBandwidth: '150 GB', usagePct: 32, version: '3.4.1', uptime: '0%', lastSeen: '2 hours ago', status: 'Offline', template: 'CAD Gateway', hostedApps: ['CAD'] },
        { id: 'Chicago-GW-02', name: 'rms-gateway', type: 'gateway', location: 'Chicago HQ', connectors: 2, usageBandwidth: '180 GB', usagePct: 41, version: '3.4.1', uptime: '99.99%', lastSeen: '30 sec ago', status: 'Online', template: 'RMS Gateway', hostedApps: ['RMS'] },
        { id: 'Chicago-Dev-01', name: 'workstation-device', type: 'device', location: 'Chicago HQ', connectors: 2, usageBandwidth: '82 GB', usagePct: 15, version: '3.3.8', uptime: '99.95%', lastSeen: '1 min ago', status: 'Online', template: 'Workstation', hostedApps: [] },
        { id: 'Chicago-Dev-02', name: 'mobile-device-unit', type: 'device', location: 'Chicago HQ', connectors: 2, usageBandwidth: '64 GB', usagePct: 18, version: '3.4.1', uptime: '98.50%', lastSeen: '5 min ago', status: 'Online', template: 'Mobile Device', hostedApps: ['Criminal Profiling System', 'Patrol Route Optimizer'] },
        { id: 'Austin-Host-03', name: 'mobile-unit-device', type: 'device', location: 'Austin Office', connectors: 4, usageBandwidth: '284 GB', usagePct: 61, version: '3.4.0', uptime: '97.20%', lastSeen: '12 min ago', status: 'Degraded', template: 'Mobile Unit', hostedApps: [] },
        { id: 'NY-CL-01', name: 'gis-gateway', type: 'gateway', location: 'New York DC', connectors: 5, usageBandwidth: '198 GB', usagePct: 43, version: '3.4.1', uptime: '100%', lastSeen: 'Just now', status: 'Online', template: 'GIS Gateway', hostedApps: ['GIS'] },
        { id: 'London-GW-01', name: 'cim-gateway', type: 'gateway', location: 'London Office', connectors: 2, usageBandwidth: '60 GB', usagePct: 13, version: '3.4.1', uptime: '0%', lastSeen: '3 days ago', status: 'Offline', template: 'CIM Gateway', hostedApps: ['CIM'] },
        { id: 'London-Dev-01', name: 'workstation-device', type: 'device', location: 'London Office', connectors: 1, usageBandwidth: '26 GB', usagePct: 5, version: '3.4.0', uptime: '0%', lastSeen: '3 days ago', status: 'Offline', template: 'Workstation', hostedApps: [] },
      ],
      connectionList: [
      ...
      identityList: [
        { id: 'id-001', name: 'Alice Monroe', type: 'user', location: 'Chicago HQ', device: 'MacBook Pro', status: 'Connected', boundServices: [{ name: 'Corporate VPN', role: 'dial' }], lastConnected: '2 min ago', requestsSent: 1420, requestsReceived: 892, bandwidthSent: '2.1 GB', bandwidthReceived: '8.4 GB', bandwidthSentPct: 42, bandwidthReceivedPct: 78, throughputSent: '14.2 MB/s', throughputReceived: '18.6 MB/s', droppedPackets: 0, droppedConnections: 0, uptime: '99.95%', usageBandwidth: '10.5 GB', usagePct: 22, connectorStatus: 'Online' },
        { id: 'id-002', name: 'Bob Carter', type: 'user', location: 'Austin Office', device: 'Windows Laptop', status: 'Connected', boundServices: [{ name: 'Remote Desktop', role: 'dial' }], lastConnected: '5 min ago', requestsSent: 340, requestsReceived: 210, bandwidthSent: '0.8 GB', bandwidthReceived: '3.2 GB', bandwidthSentPct: 18, bandwidthReceivedPct: 34, throughputSent: '3.1 MB/s', throughputReceived: '4.2 MB/s', droppedPackets: 2, droppedConnections: 0, uptime: '97.20%', usageBandwidth: '4.0 GB', usagePct: 10, connectorStatus: 'Degraded' },
        { id: 'id-003', name: 'Carol Singh', type: 'user', location: 'New York DC', device: 'iPad', status: 'Connected', boundServices: [{ name: 'Web Portal', role: 'dial' }], lastConnected: '12 min ago', requestsSent: 88, requestsReceived: 54, bandwidthSent: '0.1 GB', bandwidthReceived: '0.3 GB', bandwidthSentPct: 6, bandwidthReceivedPct: 9, throughputSent: '0.4 MB/s', throughputReceived: '0.6 MB/s', droppedPackets: 0, droppedConnections: 0, uptime: '99.99%', usageBandwidth: '0.4 GB', usagePct: 4, connectorStatus: 'Online' },
        { id: 'id-004', name: 'Dave Kim', type: 'user', location: 'Chicago HQ', device: 'iPhone', status: 'Connected', boundServices: [{ name: 'SSH Tunnel', role: 'dial' }, { name: 'Corporate VPN', role: 'dial' }], lastConnected: '8 min ago', requestsSent: 212, requestsReceived: 180, bandwidthSent: '0.05 GB', bandwidthReceived: '0.1 GB', bandwidthSentPct: 4, bandwidthReceivedPct: 6, throughputSent: '0.1 MB/s', throughputReceived: '0.2 MB/s', droppedPackets: 0, droppedConnections: 0, uptime: '97.20%', usageBandwidth: '0.15 GB', usagePct: 2, connectorStatus: 'Degraded' },
        { id: 'id-005', name: 'Chicago Gateway 1', type: 'gateway', status: 'Disconnected', boundServices: [{ name: 'Corporate VPN', role: 'bind' }, { name: 'SSH Tunnel', role: 'bind' }], lastConnected: '2 hours ago', requestsSent: 0, requestsReceived: 0, bandwidthSent: '0 GB', bandwidthReceived: '0 GB', bandwidthSentPct: 0, bandwidthReceivedPct: 0, throughputSent: '0 MB/s', throughputReceived: '0 MB/s', droppedPackets: 14, droppedConnections: 3, uptime: '0%', usageBandwidth: '0 GB', usagePct: 0, connectorStatus: 'Offline' },
        { id: 'id-006', name: 'NY Web Portal', type: 'clientless', location: 'New York DC', status: 'Connected', boundServices: [{ name: 'Web Portal', role: 'bind' }], lastConnected: 'Just now', requestsSent: 9240, requestsReceived: 4120, bandwidthSent: '12.4 GB', bandwidthReceived: '24.8 GB', bandwidthSentPct: 88, bandwidthReceivedPct: 94, throughputSent: '8.2 MB/s', throughputReceived: '16.4 MB/s', droppedPackets: 0, droppedConnections: 0, uptime: '99.98%', usageBandwidth: '198 GB', usagePct: 43, connectorStatus: 'Online' },
        { id: 'id-007', name: 'Elena Park', type: 'user', location: 'London Office', device: 'MacBook Air', status: 'Connected', boundServices: [{ name: 'Corporate VPN', role: 'dial' }], lastConnected: '1 min ago', requestsSent: 640, requestsReceived: 420, bandwidthSent: '1.4 GB', bandwidthReceived: '5.2 GB', bandwidthSentPct: 28, bandwidthReceivedPct: 52, throughputSent: '6.8 MB/s', throughputReceived: '9.4 MB/s', droppedPackets: 0, droppedConnections: 0, uptime: '99.99%', usageBandwidth: '6.6 GB', usagePct: 14, connectorStatus: 'Online' },
        { id: 'id-008', name: 'Frank Osei', type: 'user', location: 'Austin Office', device: 'Windows Desktop', status: 'Disconnected', boundServices: [{ name: 'Remote Desktop', role: 'dial' }], lastConnected: '34 min ago', requestsSent: 120, requestsReceived: 88, bandwidthSent: '0.3 GB', bandwidthReceived: '1.1 GB', bandwidthSentPct: 8, bandwidthReceivedPct: 18, throughputSent: '0 MB/s', throughputReceived: '0 MB/s', droppedPackets: 0, droppedConnections: 0, uptime: '94.10%', usageBandwidth: '1.4 GB', usagePct: 6, connectorStatus: 'Online' },
        { id: 'id-009', name: 'Grace Liu', type: 'user', location: 'New York DC', device: 'MacBook Pro', status: 'Connected', boundServices: [{ name: 'Web Portal', role: 'dial' }, { name: 'Corporate VPN', role: 'dial' }], lastConnected: '6 min ago', requestsSent: 880, requestsReceived: 560, bandwidthSent: '2.8 GB', bandwidthReceived: '9.6 GB', bandwidthSentPct: 54, bandwidthReceivedPct: 72, throughputSent: '11.2 MB/s', throughputReceived: '14.8 MB/s', droppedPackets: 1, droppedConnections: 0, uptime: '99.80%', usageBandwidth: '12.4 GB', usagePct: 26, connectorStatus: 'Degraded' },
        { id: 'id-010', name: 'Chicago Device 1', type: 'device', status: 'Connected', boundServices: [{ name: 'Remote Desktop', role: 'bind' }], lastConnected: '1 min ago', requestsSent: 3100, requestsReceived: 1840, bandwidthSent: '8.2 GB', bandwidthReceived: '16.6 GB', bandwidthSentPct: 62, bandwidthReceivedPct: 70, throughputSent: '5.4 MB/s', throughputReceived: '10.8 MB/s', droppedPackets: 0, droppedConnections: 0, uptime: '99.95%', usageBandwidth: '82 GB', usagePct: 15, connectorStatus: 'Online' },
        { id: 'id-011', name: 'Henry Walsh', type: 'user', location: 'Chicago HQ', device: 'Linux Workstation', status: 'Connected', boundServices: [{ name: 'SSH Tunnel', role: 'dial' }], lastConnected: '18 min ago', requestsSent: 56, requestsReceived: 44, bandwidthSent: '0.02 GB', bandwidthReceived: '0.08 GB', bandwidthSentPct: 2, bandwidthReceivedPct: 4, throughputSent: '0.2 MB/s', throughputReceived: '0.4 MB/s', droppedPackets: 0, droppedConnections: 0, uptime: '98.60%', usageBandwidth: '0.1 GB', usagePct: 1, connectorStatus: 'Online' },
        { id: 'id-012', name: 'Chicago Gateway 2', type: 'gateway', status: 'Connected', boundServices: [{ name: 'Corporate VPN', role: 'bind' }, { name: 'Web Portal', role: 'bind' }], lastConnected: '30 sec ago', requestsSent: 18400, requestsReceived: 9200, bandwidthSent: '44.2 GB', bandwidthReceived: '88.8 GB', bandwidthSentPct: 90, bandwidthReceivedPct: 96, throughputSent: '22.4 MB/s', throughputReceived: '44.6 MB/s', droppedPackets: 0, droppedConnections: 0, uptime: '99.99%', usageBandwidth: '180 GB', usagePct: 41, connectorStatus: 'Online' },
      ],
      userList: [
    ...
    },
    {
      ...
      connectionList: [],
      identityList: [
        { id: 'id-001', name: 'LA Gateway 1', type: 'gateway', status: 'Disconnected', boundServices: [{ name: 'Web Access', role: 'bind' }], lastConnected: '3 days ago', requestsSent: 0, requestsReceived: 0, bandwidthSent: '0 GB', bandwidthReceived: '0 GB', bandwidthSentPct: 0, bandwidthReceivedPct: 0, throughputSent: '0 MB/s', throughputReceived: '0 MB/s', droppedPackets: 0, droppedConnections: 0, uptime: '0%', usageBandwidth: '0 GB', usagePct: 0, connectorStatus: 'Offline' },
        { id: 'id-002', name: 'LA Device Node', type: 'device', location: 'Los Angeles HQ', status: 'Disconnected', boundServices: [{ name: 'Remote Desktop', role: 'dial' }], lastConnected: '3 days ago', requestsSent: 0, requestsReceived: 0, bandwidthSent: '0 GB', bandwidthReceived: '0 GB', bandwidthSentPct: 0, bandwidthReceivedPct: 0, throughputSent: '0 MB/s', throughputReceived: '0 MB/s', droppedPackets: 0, droppedConnections: 0, uptime: '0%', usageBandwidth: '0 GB', usagePct: 0, connectorStatus: 'Offline' },
      ],
      userList: [
