  ...
  private customers: Customer[] = [
    ...
    },
    {
      ...
      identityList: [
        ...
        { id: 'id-004', name: 'Portland Office Node', type: 'gateway', status: 'Disconnected', boundServices: [{ name: 'Office Suite', role: 'bind' }], lastConnected: '30 min ago', requestsSent: 0, requestsReceived: 0, bandwidthSent: '0 GB', bandwidthReceived: '0 GB', bandwidthSentPct: 0, bandwidthReceivedPct: 0, throughputSent: '0 MB/s', throughputReceived: '0 MB/s', droppedPackets: 18, droppedConnections: 4 },
      ],
      userList: [
